...
namespace Jitter.Models
{
    public class JitterRepository
    {
        ...
        {
            // select * from JitterUsers AS users.FirstName like %search_term% OR users.LastName like %search_term%;
        ...
        {
            Jot a_jot = new Jot { Content = "Hello Jitter World!", Date = DateTime.Now, Author = jitter_user1 };
            bool is_added = true;
