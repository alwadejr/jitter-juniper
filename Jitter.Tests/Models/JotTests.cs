...
namespace Jitter.Tests.Models
{
    ...
    public class JotTests
    {
        ...
        public void JotEnsureJotHasAllTheThings()
        {
            ...
            a_jot.Picture = "https://imgur.com/Iamaphoto.jpeg";
            ...
            Assert.AreEqual("https://imgur.com/Iamaphoto.jpeg", a_jot.Picture);
        }
        ...
        public void JotEnsureICanUseObjectInitializerSyntax() 
        {
            ...
            Jot a_jot = new Jot { JotId = 1, Content = "My Content", Date = expected_time, Author = null, Picture = "https://imgur.com/Iamaphoto.jpeg" };
